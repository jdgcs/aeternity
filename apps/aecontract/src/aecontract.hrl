...
-define(IS_VM_SOPHIA(___VM_VERSION___), (___VM_VERSION___ =:= ?VM_AEVM_SOPHIA_3
                                         orelse ___VM_VERSION___ =:= ?VM_AEVM_SOPHIA_2
                                         orelse ___VM_VERSION___ =:= ?VM_AEVM_SOPHIA_1)).
